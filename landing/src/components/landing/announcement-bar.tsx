...
export function AnnouncementBar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 h-9 bg-surface-900 border-b border-signal-dim/20 flex items-center justify-center gap-2 text-xs">
      ...
      <button
        ...
        className="absolute right-3 flex items-center justify-center rounded-md p-1 text-surface-400 hover:text-text-primary hover:bg-panel-raised transition-colors"
