...
> **Since writing:** v1.0.0b5 ships temporal edge expiry with effective-at-now reconciliation, plus fact retraction and LLM-based invalidation — the supersession machinery above now has a shipped invalidation layer. See the [v1.0.0b5 changelog](/changelog/v1-0-0b5).
